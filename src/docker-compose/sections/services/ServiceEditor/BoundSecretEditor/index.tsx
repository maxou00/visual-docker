   ...
   <HStack w='full' alignItems='flex-start' spacing={4}>
    <FormControl>
     ...
     <Input
      ...
      placeholder=''
      value={entry.target}
      onChange={({ target }) => onChange({ ...entry, target: target.value })}
     />
     <FormHelperText>
      Enter the path where this config should be mounted within the container.
 ...
 return (
  <VStack w='full' alignItems='flex-start' spacing={4}>
   <VStack w='full' alignItems='flex-start' spacing={2}>
    ...
    <Text fontSize='sm'>Here are listed secrets bound to this service.</Text>
   </VStack>
